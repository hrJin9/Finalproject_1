...
<div class="contentsmargin">
	<form action="#" class="booking-form ml-3" style="float: right; margin-bottom: 0;">
		<div class="row" style="margin-bottom: 13px;">
			...
			<div>
				<span class="groupIcon" id="sidemenu">
					<span><i class="fas fa-sitemap update" style="position: absolute; left: 8.5px; bottom:8.2px; font-size: 10pt;"></i></span>
	            </span>
			</div>
		</div>
	</form>
       ...
       <colgroup>
     	...
     	<tbody>
           <tr>
		      ...
		      <span class="pic">
			      <span>지은</span></span>
			      <span class="my"><span class="name" style="font-size: 9.5pt;">김지은</span><br>
			      <span class="role" style="font-size: 7pt;">개발자</span>
		      </span>
                </div>
              </td> 
              <td>
           ...
           <tr>
		      ...
		      <span class="pic">
			      <span>혜린</span></span>
			      <span class="my"><span class="name" style="font-size: 9.5pt;">진혜린</span><br>
			      <span class="role" style="font-size: 7pt;">개발자</span>
		      </span>
                </div>
              </td> 
           ...
           <tr>
		      ...
		      <span class="pic">
			      <span>채영</span></span>
			      <span class="my"><span class="name" style="font-size: 9.5pt;">강채영</span><br>
			      <span class="role" style="font-size: 7pt;">디자이너</span>
		      </span>
                </div>
              </td> 
              <td>
           ...
           <tr>
		      ...
		      <span class="pic">
			      <span>예은</span></span>
			      <span class="my"><span class="name" style="font-size: 9.5pt;">이예은</span><br>
			      <span class="role" style="font-size: 7pt;">기획자</span>
		      </span>
                </div>
              </td> 
              <td>
