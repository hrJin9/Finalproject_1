...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("select.calType").change(function(){
			...
			console.log('fk_lgcatgono=>'+fk_lgcatgono)
			console.log('fk_employee_no=>'+fk_employee_no)
		...
		//	console.log("공유자 => " + joinuser);
			...
			frm.action="<%= ctxPath%>/schedule/registerSchedule_end.up";
			frm.method="post";
			frm.submit();
...
<nav id="admin_mainList" class="margin-container">
	<a id="admin_memberList" class="header-nonsub">일정 생성</a> 
</nav>
<hr class="HRhr" style="margin-top: 0px;"/><br>

	<form name="scheduleFrm">  
			<tr>
				<td><input type="text" id="subject" name="subject" class="form-control" aria-describedby="emailHelp" placeholder="제목을 입력하세요(필수)" style="border: none;margin-left: 5%;max-width: 86%;"/></td>
			</tr> 
			<hr style="max-width: 86%;margin-left: 5%;margin-bottom: 3%;opacity: 25%;">  
	...
	<button type="button" id="del_register" class="btn_normal" style="" onclick="javascript:location.href='<%= ctxPath%>/schedule/scheduleManagement.up'">취소</button> 
	</div>  
</div>