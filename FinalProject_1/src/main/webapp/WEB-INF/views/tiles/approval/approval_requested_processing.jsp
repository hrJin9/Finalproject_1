...
<nav id="subList" class="margin-container appreqsublist">
	<div style="display: contents;">
		...
		<a  class="header-sub list_iscurrent" href="<%= request.getContextPath()%>/approval/requested/processing.up" style="margin-left: 1%;">결재완료</a>
		<a  class="header-sub list_notcurrent" href="<%= request.getContextPath()%>/approval/requested/refered.up" style="margin-left: 1%;">참조문서</a>
	</div>
	<div class="subList_underline" style="left: 8.5%;"></div>
	<div class="rightbtn">
	<!-- **** 검색필터 **** --> 
