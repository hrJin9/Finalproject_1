...
<nav id="mainList" class="margin-container header-nav">
	<a class="header-nonsub list_iscurrent" id="notice" href="<%= request.getContextPath()%>/board_all.up">공지사항</a>
	<a class="header-nonsub list_notcurrent" id="freeboard" href="<%= request.getContextPath()%>/freeboard.up">자유게시판</a>
