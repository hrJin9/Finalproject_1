...
<nav id="mainList" class="margin-container header-nav">
	<a class="header-main list_iscurrent" id="notice" href="<%= request.getContextPath()%>/board_all.up" style="margin-left: 2%;">공지사항</a>
	<a class="header-main list_notcurrent" id="freeboard" href="<%= request.getContextPath()%>/freeboard.up" style="margin-left: 2%;">자유게시판</a>
	<%-- <a class="header-main list_notcurrent" id="myboard" href="<%= request.getContextPath()%>/board/myboard.up">내 게시물</a> --%><!-- 작성한 게시물, 북마크, 임시저장 -->
</nav>

<!-- 권한부여받은사람만 글쓰기버튼 뜨기 -->
 <div style="display: inline-block;position: relative;float: right;right: 78px;top: -41px; margin-bottom: -14px;">
...
<hr class="HRhr" style="margin-top: 0px; width: 100%;"/>
