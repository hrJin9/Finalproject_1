...
<nav id="attendance_mainList" class="margin-container">
	<a id="attendance" href="<%= ctxPath%>/attendance.up" style="color: black;" class="header-nonsub">내 근무</a>
	<a id="dayoff" href="<%= ctxPath%>/dayoff/index.up" class="iscurrent header-nonsub">내 휴가</a>
