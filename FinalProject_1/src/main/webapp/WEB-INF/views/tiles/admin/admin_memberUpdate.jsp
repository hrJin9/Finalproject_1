...
$(document).ready(function(){
	...
	//초기 팀값 설정하기
	getTeams("${requestScope.evo.fk_department_no}");
	
	
	//초기값 설정해주기
	$("#gender").val("${requestScope.evo.gender}");
	$("#jointype").val("${requestScope.evo.jointype}");
	$("#dept").val("${requestScope.evo.fk_department_no}");
	$("#team").val("${requestScope.evo.fk_team_no}");
	$("#position").val("${requestScope.evo.position}");
	$("#militaryservice").val("${requestScope.evo.militaryservice}");
	$("#bank").val("${requestScope.evo.bank}");
	$("#employmenttype").val("${requestScope.evo.employmenttype}");
	...
	<form name="memberUpdate">
		       ...
		       <colgroup>
		          ...
		          <tbody>
		                <tr>
		                   ...
		                   <td colspan="3">
		                   	<input type="text" class="required" id="name"  name="name_kr" size="10" value="${requestScope.evo.name_kr}" placeholder="이름" />
		                   	<div class="alerts" style="color:#4285f4;"></div>
		                   	</td>   
		                </tr>
		                <tr>
		                   <td>영문이름</td>   
		                   <td colspan="3"><input type="text" class="required" id="egname"  name="name_en" size="10" value="${requestScope.evo.name_en}" placeholder="영문이름" /></td>   
		                </tr>
		                <tr>
		                   <td>생년월일<span class="essentials">*</span></td>   
		                   <td style="float:left; margin-right:0;"><input id="birthday" name="birthday" class="dateSelector" placeholder="ex) 2020-09-01" value="${requestScope.evo.birthday}" /><div class="alerts" style="color:#4285f4;"></div></td>   
		...
		<div class="infocontainer" style="margin-left: 2%;">
		       ...
		       <colgroup>
		          ...
		          <tbody>
		                ...
		                <tr>
		                   ...
		                   <td><input class="dateSelector" id="joindate" name="hire_date" value="${requestScope.evo.hire_date}" placeholder="ex) 2020-09-01" /><div class="alerts" style="color:#4285f4;"></div></td>  
		                </tr>
		                <tr>
		                ...
		                <tr>
		                   ...
		                   <td><input type="text" class="required" id="role" name="role" size="40" value="${requestScope.evo.role}" placeholder="직무" /><div class="alerts" style="color:#4285f4;"></div></td>   
		                </tr>
						<tr>
		       ...
		       <colgroup>
		          ...
		          <tbody>
		                <tr>
		                   ...
		                   <td>
		                   	<input type="text" class="required" id="email"  name="email" size="50" value="${requestScope.evo.email}" placeholder="이메일" />
		                   	<div class="alerts" style="color:#4285f4;"></div>
	                   		</td>   
		                </tr>
		                <tr>
		                ...
		                <tr>
		                   <td>최종학력</td>  
		                   <td><input type="text" class="required" id="academic_ability"  name="academic_ability" size="50" value="${requestScope.evo.academic_ability }" placeholder="고졸/초대졸/대졸" /></td> 
		                </tr>
		                <tr>
		                   <td>전공</td>  
		                   <td><input type="text" class="required" id="major"  name="major" size="50" value="${requestScope.evo.major}" placeholder="전공" /></td> 
		                </tr>
		                <tr>
		                   <td>병역사항</td>  
		                   <td>
		                ...
		                <tr>
		                   ...
		                   <td>	
							...
							<input id=accountNumber type="text" class="required" name="accountnumber" value="${requestScope.evo.accountnumber}" size="20" placeholder="계좌번호" style="display: inline-block; width: 31.5%; padding: 2px 12px;"/>
	      ...
	      <div class="workstatus-buttoncontainer" style="margin-right: 40%;">
			 <button type="button" class="workstatus-save bluebtn btn" onclick="goSubmit()">수정하기</button>
