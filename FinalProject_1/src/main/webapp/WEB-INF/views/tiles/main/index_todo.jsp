...
<div class="main_container">
    ...
    <div class="bg-light text-dark">
	   	...
	   	<div class="card-body" style="height: 80px; display: table-cell; vertical-align: middle; clear: both; width: 1177px;">
    ...
    <div class="bg-light text-dark">
	   	<i class="fas fa-user-circle" style="color:#737373; font-size:33px; float: left; padding: 20px 0 20px 35px;"></i>
	   	<div class="card-body" style="height: 80px; display: table-cell; vertical-align: middle; width: 1177px;">
