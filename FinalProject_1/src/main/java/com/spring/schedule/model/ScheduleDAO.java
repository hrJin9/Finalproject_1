...
public class ScheduleDAO implements InterScheduleDAO {
	...
	public List<Calendar_small_category_VO> showMyCalendar(String fk_employee_no) {
		List<Calendar_small_category_VO> calendar_small_category_VO_MyList = sqlsession.selectList("schedule.showMyCalendar", fk_employee_no);  
	...
	public List<Calendar_schedule_VO> selectSchedule(String fk_employee_no) {
		List<Calendar_schedule_VO> scheduleList = sqlsession.selectList("schedule.selectSchedule", fk_employee_no);
		return scheduleList;
	}
