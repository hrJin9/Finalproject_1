...
public interface InterScheduleService {
	...
	List<Calendar_small_category_VO> showMyCalendar(String fk_employee_no);
	...
	// 등록된 일정 가져오기
	List<Calendar_schedule_VO> selectSchedule(String fk_employee_no);

	// 일정 상세 보기 
	Map<String, String> detailSchedule(String calno);

	// 일정삭제하기  
	int deleteSchedule(String calno) throws Throwable; 
